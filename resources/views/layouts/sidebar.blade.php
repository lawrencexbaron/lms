<div class="flex flex-col min-h-full bg-white shadow">
    ...
    <div class="flex flex-col w-full px-2 py-2 gap-1" x-data="toggleEnrolled()">
        ...
        <ul class="ml-5 transition ease-linear" x-show="open">
            <li class="py-2 px-4 rounded-md cursor-pointer ease-line hover:bg-blue-100 transition hover:text-blue-900 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <li class="flex items-center gap-2 py-3 px-4 cursor-pointer hover:bg-gray-50 transition hover:text-blue-900">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
