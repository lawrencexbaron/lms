    ...
    <div class="py-12">
        <div class="max-w-7xl px-2 py-2 mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded border">
                ...
                <form action="{{ route('section.store') }}" class="px-4 py-5 flex flex-col" method="POST">
                    @csrf
                    <div class="sm:flex w-full gap-1">
                        ...
                        <div class="w-full">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea placeholder="Optional" name="section_description" id="section_description" cols="30" rows="2" class="w-full border-gray-300 rounded resize-none focus:border-indigo-600 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
