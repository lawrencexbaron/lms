    ...
    <div class="py-12">
        <div class="max-w-7xl px-2 py-2 mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded border">
                ...
                <form action="{{ route('advisers.update', $adviser->id) }}" class="px-4 py-5 flex flex-col" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="sm:flex w-full gap-1">
                        <div class="w-full">
                            <div class="mb-2">
                                ...
                                <x-text-input id="first_name" class="w-full" name="first_name" type="text" placeholder="Enter First name" :value="$adviser->first_name" />
                            ...
                            <div class="mb-2">
                                ...
                                <x-text-input id="middle_name" class="w-full" name="middle_name" type="text" placeholder="Enter Middle name" :value="$adviser->middle_name" />
                            ...
                            <div class="mb-2">
                                ...
                                <x-text-input id="last_name" class="w-full" name="last_name" type="text" placeholder="Enter Last name" :value="$adviser->last_name" />
                            ...
                            <div class="mb-2">
                                ...
                                <x-text-input id="email" class="w-full" name="email" type="text" placeholder="Enter Email" :value="$adviser->email" />
                                <x-input-error :messages="$errors->get('email')" class="" />
                            </div>
                            <div class="mb-2">
                                <x-input-label for="phone" class="font-bold text-gray-800">Phone Number</x-input-label>
                                <x-text-input id="phone" class="w-full" name="phone" type="text" placeholder="Enter Phone Number" :value="$adviser->phone" />
